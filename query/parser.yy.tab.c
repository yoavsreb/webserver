...
const int YY_parse_CLASS::PLUS=258;
const int YY_parse_CLASS::MULTIPLY=259;
const int YY_parse_CLASS::LPAREN=260;
const int YY_parse_CLASS::RPAREN=261;
const int YY_parse_CLASS::NUMBER=262;
const int YY_parse_CLASS::UUID=263;
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 263 ? yytranslate[x] : 10)
...
static const char * const yytname[] = {   "$","error","$illegal.","PLUS","MULTIPLY",
"LPAREN","RPAREN","NUMBER","UUID","program",""
};
#endif
...
#line 31 "parser.yy"
{
    std::cout << "Found a sentence: " << yyvsp[-1].value << std::endl;        ;
    break;}
}
