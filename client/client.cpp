...
void createMessage(const std::string& path, const std::string& body, const std::string& output) {
...
int main(int argc, char** argv) {
    ...
    ("help", "produce help message")
        ("path", po::value<std::string>(), "Path to resource")
        ("body", po::value<std::string>(), "Body of payload")
